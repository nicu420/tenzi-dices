    ...
    switch (value) {
      case 1:
        dice = (
          <button
            onClick={handleClick}
            className="group rounded-lg border-4 border-green-400 p-2 sm:p-3 text-center hover:border-green-300 lg:p-4"
          >
    ...
    switch (value) {
      case 1:
        dice = (
          <button
            onClick={handleClick}
            className="group rounded-lg border-4 border-zinc-400 p-2 sm:p-3 text-center hover:border-zinc-300 lg:p-4"
          >
            <div className="relative flex h-7 w-7 items-center justify-center sm:h-7 sm:w-7 lg:h-12 lg:w-12">
